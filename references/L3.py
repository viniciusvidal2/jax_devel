...
class StoryDataset:
    ...
    def __init__(self, stories: list[str], maxlen: int, tokenizer: tiktoken.Encoding) -> None:
        """
        Initialize the StoryDataset.

        Parameters:
            stories (list[str]): List of story strings.
            maxlen (int): Maximum sequence length.
            tokenizer (tiktoken.Encoding): Tokenizer to encode the stories.
        """
    ...
    def __len__(self) -> int:
        """
        Get the number of stories in the dataset.

        Returns:
            int: The number of stories.
        """
        return len(self.stories)

    def __getitem__(self, idx: int) -> list[int]:
        """
        Get a tokenized story sample from the dataset.

        Parameters:
            idx (int): The index of the story.

        Returns:
            list[int]: The list of tokens, padded to maxlen.
        """
...
def print_sampler_example(sampler: grain.IndexSampler, name: str) -> None:
    """
    Print record indices generated by a sampler.

    Parameters:
        sampler (grain.IndexSampler): The sampler to iterate over.
        name (str): Name of the sampler example for display.
    """
    print(f"\n{name}")
...
def create_dataloader(
    ...
    """
    Build a grain DataLoader for stories.

    Parameters:
        stories (list[str]): The stories data.
        tokenizer (tiktoken.Encoding): The tokenizer for tokenization.
        maxlen (int): Maximum sequence length.
    ...
    Returns:
        tuple[grain.DataLoader, int]: The DataLoader and estimated number of batches.
    """
